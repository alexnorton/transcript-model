...
/***/ function(module, exports, __webpack_require__) {
	...
	var Transcript = function (_TranscriptRecord) {
	  ...
	  _createClass(Transcript, [{
	    ...
	    key: 'fromKaldi',
	    value: function fromKaldi(transcriptJson, segmentsJson) {
	      // Create a map of Kaldi speaker IDs to numeric speaker IDs, e.g. S0: 0, S4: 1, ...
	      var speakerIdMap = {};

	      var speakers = new _immutable2.default.List(segmentsJson.speakers.map(function (s, i) {
	        speakerIdMap[s['@id']] = i;
	      ...
	      var segments = new _immutable2.default.List(segmentsJson.segments.map(function (s) {
	        return new _TranscriptSegment2.default({
	          speaker: speakerIdMap[s.speaker['@id']],
	          words: new _immutable2.default.List(transcriptJson.words.filter(function (_ref3) {
	            var start = _ref3.start,
	                end = _ref3.end;
	            return start >= s.start && end <= s.start + s.duration;
	          }).map(function (w) {
	            return new _TranscriptWord2.default({
	              text: w.word,
	              start: w.start,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TranscriptSegment = function (_TranscriptSegmentRec) {
	  ...
	  _createClass(TranscriptSegment, [{
	    key: 'getStart',
